      ...
      <main className={style.former_plans}>
        ...
        <form method="post" className={style.form}>
          <div className={style.rows}>
            ...
            <Link to={"/plans/strength"} className={style.field}>
              {" "}
              Styrketrening{" "}
            </Link>
          </div>
          <div className={style.rows}>
            ...
            <Link to={"/plans/running"} className={style.field}>
              {" "}
              Løping{" "}
            </Link>
          </div>
          <div className={style.rows}>
            ...
            <Link to={"/plans/cycling"} className={style.field}>
              {" "}
              Sykling{" "}
            </Link>
          </div>
          <div className={style.rows}>
            ...
            <Link to={"/plans/swimming"} className={style.field}>
              {" "}
              Svømming{" "}
            </Link>
          </div>
